...
class Calculation(object):
    ...
    def getData(self, redshiftindex):
        ...
        dimensions = (self.endshape[0] // 2, self.endshape[1])
        for quantity, FT in list(FValuenew.items()):
            FT_abs = np.abs(FT)
    ...
    def getTransferData(self, redshiftindex):
        return {field: transfer_function[redshiftindex](self.krange) for field, transfer_function in list(self.TransferFunctionList.items())}, self.krange
