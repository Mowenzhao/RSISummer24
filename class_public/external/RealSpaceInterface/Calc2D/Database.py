...
class Database:
    ...
    def __read_database(self):
        ...
        with open(self.db_path, "rb") as f:
            return pickle.load(f, encoding='latin1') ####################################################### PROBLEM (solved!?)

    def __write_database(self):
        # with open(self.db_path, "w") as f:
        with open(self.db_path, "wb") as f:
            pickle.dump(self.db, f, protocol=pickle.HIGHEST_PROTOCOL) ###################################### PROBLEM (solved!?)
    ...
    def __get_frozen_key(self, key):
        return frozenset(list(key.items()))
